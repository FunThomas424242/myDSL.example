...
public class MyDSLFactoryImpl extends EFactoryImpl implements MyDSLFactory
{
  ...
  public static MyDSLFactory init()
  {
    try
    {
      MyDSLFactory theMyDSLFactory = (MyDSLFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.emftext.org/language/myDSL"); 
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case MyDSLPackage.ENTITY_MODEL: return createEntityModel();
  ...
  public Object createFromString(EDataType eDataType, String initialValue)
  {
    ...
    {
      case MyDSLPackage.FEATURE_KIND:
